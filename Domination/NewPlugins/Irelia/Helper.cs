...
namespace DominationAIO.NewPlugins
{
    public static class Helper
    {
        ...
        {
            if (Variables.GameTimeTickCount > Irelia.SheenTimer + 1650 + Game.Ping 
        ...
        public static double GetQDmg(AIBaseClient target, bool CheckItem = true)
        {
            ...
            var num2 = 43 + (ObjectManager.Player.Level * 12);
            ...
            {
                var PassiveDmg = 10.0f + (ObjectManager.Player.Level - 1) * 3.0f + ObjectManager.Player.GetBonusPhysicalDamage() * 0.3f;
        ...
        public static bool CanQ(AIBaseClient target, bool CheckItems = true)
        {
            ...
            */
            ...
            {
                if (target.Health <= GetQDmg(target, CheckItems) * 1.1f)
                {
                    return true;
                }
            }
